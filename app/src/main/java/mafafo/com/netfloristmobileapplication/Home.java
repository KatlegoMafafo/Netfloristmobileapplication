...
import mafafo.com.netfloristmobileapplication.Model.Category;
import mafafo.com.netfloristmobileapplication.ViewHolder.MenuViewHolder;
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, final int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int postion, boolean isLongClick) {
                        ...
                        Intent cakelist = new Intent(Home.this, ProductsList.class);
